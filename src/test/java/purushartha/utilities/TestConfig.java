package purushartha.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "shimoni1990@gmail.com";
	public static String password = "SHIMONI@1990";
	public static String[] to ={"namithas61@gmail.com"};
